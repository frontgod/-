...
public class EntityUtil {
	...
	private final String moduleName = "Demo"; // 数据库名称

	private final String bean_path = "E:\\workspace\\case_seed\\src\\main\\java";

	private final String mapper_path = "E:\\workspace\\case_seed\\src\\main\\java\\com\\bmw\\seed\\dao";

	private final String xml_path = "E:\\workspace\\case_seed\\src\\main\\resources\\mapping";// xml路径

	private final String model_package = "com.bmw.seed.model";// model的包所在

	private final String dao_package = "com.bmw.seed.dao";// dao的包所在
	...
	private void buildMapper(List<String> columns, List<String> types) throws IOException {
		...
		bw.newLine();
		bw.write("import com.bmw.seed.util.bean.CommonQueryBean;");
		bw.newLine();
		bw.newLine();
